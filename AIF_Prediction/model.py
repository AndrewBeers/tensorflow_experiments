...
class Model():
    ...
    def load_old_data(self):
        ...
        # Model Data
        # trainset = ToftsSequenceData(n_samples=n_samples_train_test[0], max_seq_len=max_seq_len)
        # testset = ToftsSequenceData(n_samples=n_samples_train_test[1], max_seq_len=max_seq_len)
        ...
        # self.testset = DCEReconstructionData(dce_data = self.dce_filepath, ktrans_data = self.ktrans_filepath, ve_data = self.ve_filepath)
